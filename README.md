...
![setcoords_success.png](./assets/setcoords_success.png)

Если же населенный пункт не был найден, то координаты будут установлены на 0, 0 (по умолчанию).
![setcoords_notfound.png](./assets/setcoords_notfound.png)
...
![setradius_success.png](./assets/setradius_success.png)

Если же пользователь введет число больше максимального, либо введет не число - радиус не будет установлен.

![setradius_overflow.png](./assets/setradius_overflow.png)
![setradius_notadigit.png](./assets/setradius_notadigit.png)
...
![track_start.png](./assets/track_start.png)

Если пользователь уже отслеживает новые землетрясения, бот также проинформирует об этом.

![track_alreadytracking.png](./assets/track_alreadytracking.png)
...
![untrack_success.png](./assets/untrack_success.png)

Если же пользователь не отслеживал новые землетрясения, бот также проинформирует об этом.

![untrack_alreadynottracking.png](./assets/untrack_alreadynottracking.png)
...
Выполняет ту же функцию что и команда `/start`